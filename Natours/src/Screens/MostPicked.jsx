...
function MostPicked() {
  ...
  const favPlace = [
    ...
    },
    {
      ...
      tittle: "Rajasthan",
      details: "Explore the golden deserts and royal palaces of Rajasthan.",
    },
    {
      ...
      tittle: "Kerela",
      details: "Relax in serene backwaters on a traditional Kerala boat house.",
    },
  ];
  return (
    <div className="fav-wrapper">
      <div style={{ textAlign: "center", marginBottom: "20px" }}>
        <h1>
        Travelers' favorite choices in India
        
      </h1>
      <span style={{ color: "red", marginBottom:"10px"}}>(This is just for dummy it only shows details for
        booking kindly go to all Tours section)</span>
      </div>
      <br />
